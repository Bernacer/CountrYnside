...
use Countrynside\CalendarBundle\Form\BookingType;
...
class BookingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CountrynsideCalendarBundle:Booking')->findAll();

        return $this->render('CountrynsideCalendarBundle:Booking:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CountrynsideCalendarBundle:Booking')->find($id);
        ...
        return $this->render('CountrynsideCalendarBundle:Booking:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('CountrynsideCalendarBundle:Booking:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CountrynsideCalendarBundle:Booking:edit.html.twig', array(
            'entity'      => $entity,
