...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            // countrynside_site_voir
            if ($pathinfo === '/user/voir') {
                return array (  '_controller' => 'Countrynside\\SiteBundle\\Controller\\DefaultController::voirAction',  '_route' => 'countrynside_site_voir',);
            }
