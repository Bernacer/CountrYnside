...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'payum.context.mypayment.api' => 'getPayum_Context_Mypayment_ApiService',
            'payum.context.mypayment.payment' => 'getPayum_Context_Mypayment_PaymentService',
            ...
            'payum.storage.countrynside_paymentbundle_entity_order' => 'getPayum_Storage_CountrynsidePaymentbundleEntityOrderService',
            'payum.storage.countrynside_paymentbundle_entity_paymenttoken' => 'getPayum_Storage_CountrynsidePaymentbundleEntityPaymenttokenService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\UserBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\SiteBundle\\Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\PaymentBundle\\Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\CalendarBundle\\Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Doctrine\\Resources\\mapping') => 'Payum\\Core\\Model'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Countrynside\\UserBundle\\Entity');
        $d->addDriver($b, 'Countrynside\\SiteBundle\\Entity');
        $d->addDriver($b, 'Countrynside\\PaymentBundle\\Entity');
        $d->addDriver($b, 'Countrynside\\CalendarBundle\\Entity');
        $d->addDriver($c, 'Payum\\Core\\Model');
        ...
        $e->setEntityNamespaces(array('CountrynsideUserBundle' => 'Countrynside\\UserBundle\\Entity', 'CountrynsideSiteBundle' => 'Countrynside\\SiteBundle\\Entity', 'CountrynsidePaymentBundle' => 'Countrynside\\PaymentBundle\\Entity', 'CountrynsideCalendarBundle' => 'Countrynside\\CalendarBundle\\Entity', 'payum' => 'Payum\\Core\\Model'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/Symfony/app/logs/dev.log', 100, true, NULL);
    }
    ...
    {
        return $this->services['payment.encryption_service'] = new \JMS\Payment\CoreBundle\Cryptography\MCryptEncryptionService('asecret', 'rijndael-256', 'ctr');
    }
    ...
    {
        return $this->services['payment.form.choose_payment_method_type'] = new \JMS\Payment\CoreBundle\Form\ChoosePaymentMethodType($this->get('payment.plugin_controller'), array());
    }
    ...
    {
        $this->services['payum'] = $instance = new \Payum\Bundle\PayumBundle\Registry\ContainerAwareRegistry(array('myPayment' => 'payum.context.myPayment.payment'), array('Countrynside\\PaymentBundle\\Entity\\Order' => 'payum.storage.countrynside_paymentbundle_entity_order'), 'myPayment');
    ...
    /**
     * Gets the 'payum.context.mypayment.api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getPayum_Context_Mypayment_ApiService()
    {
        return $this->services['payum.context.mypayment.api'] = new \Payum\Paypal\ExpressCheckout\Nvp\Api(array('username' => 'philippe.paulos-facilitator_api1.hotmail.fr', 'password' => 'V4EKLDFKZFCR8HS7', 'signature' => 'AFcWxV21C7fd0v3bYYYRCpSSRl31AFBqutY937koYKVRtgsubJfGNq4m', 'sandbox' => true), $this->get('payum.buzz.client'));
    }

    /**
     * Gets the 'payum.context.mypayment.payment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getPayum_Context_Mypayment_PaymentService()
    {
        $a = $this->get('request', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        $b = new \Payum\Core\Bridge\Symfony\Action\GetHttpRequestAction();
        $b->setHttpRequest($a);

        $c = new \Payum\Core\Bridge\Symfony\Action\ObtainCreditCardAction($this->get('form.factory'), '@PayumSymfonyBridge\\obtainCreditCard.html.twig');
        $c->setRequest($a);

        $this->services['payum.context.mypayment.payment'] = $instance = new \Payum\Core\Payment();

        $instance->addApi($this->get('payum.context.mypayment.api'));
        $instance->addExtension(new \Payum\Core\Extension\EndlessCycleDetectorExtension());
        $instance->addExtension($this->get('payum.extension.log_executed_actions'));
        $instance->addExtension($this->get('payum.extension.logger'));
        $instance->addAction(new \Payum\Core\Action\CaptureOrderAction(), false);
        $instance->addAction(new \Payum\Core\Action\ExecuteSameRequestWithModelDetailsAction(), false);
        $instance->addAction($b, false);
        $instance->addAction($c, false);
        $instance->addAction(new \Payum\Core\Bridge\Twig\Action\RenderTemplateAction($this->get('twig'), '@PayumCore\\layout.html.twig'), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\AuthorizeTokenAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\DoExpressCheckoutPaymentAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\GetExpressCheckoutDetailsAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\GetTransactionDetailsAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\SetExpressCheckoutAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\CreateRecurringPaymentProfileAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\GetRecurringPaymentsProfileDetailsAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\ManageRecurringPaymentsProfileStatusAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\CreateBillingAgreementAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\Api\DoReferenceTransactionAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\FillOrderDetailsAction($this->get('payum.security.token_factory')), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\CaptureAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\NotifyAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\PaymentDetailsStatusAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\PaymentDetailsSyncAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\RecurringPaymentDetailsStatusAction(), false);
        $instance->addAction(new \Payum\Paypal\ExpressCheckout\Nvp\Action\RecurringPaymentDetailsSyncAction(), false);
        $instance->addExtension(new \Payum\Core\Extension\StorageExtension($this->get('payum.storage.countrynside_paymentbundle_entity_order')), false);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Payum\Core\Bridge\Symfony\Security\TokenFactory A Payum\Core\Bridge\Symfony\Security\TokenFactory instance.
     */
    protected function getPayum_Security_TokenFactoryService()
    {
        return $this->services['payum.security.token_factory'] = new \Payum\Core\Bridge\Symfony\Security\TokenFactory($this->get('router'), $this->get('payum.security.token_storage'), $this->get('payum'), 'payum_capture_do', 'payum_notify_do', 'payum_authorize_do', 'payum_refund_do');
    }
    ...
    {
        return $this->services['payum.security.token_storage'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Countrynside\\PaymentBundle\\Entity\\PaymentToken');
    }

    /**
     * Gets the 'payum.storage.countrynside_paymentbundle_entity_order' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage A Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage instance.
     */
    protected function getPayum_Storage_CountrynsidePaymentbundleEntityOrderService()
    {
        return $this->services['payum.storage.countrynside_paymentbundle_entity_order'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Countrynside\\PaymentBundle\\Entity\\Order');
    }

    /**
     * Gets the 'payum.storage.countrynside_paymentbundle_entity_paymenttoken' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage A Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage instance.
     */
    protected function getPayum_Storage_CountrynsidePaymentbundleEntityPaymenttokenService()
    {
        return $this->services['payum.storage.countrynside_paymentbundle_entity_paymenttoken'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Countrynside\\PaymentBundle\\Entity\\PaymentToken');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54aaa28e10528', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml'), 'fr', 'FOSUserBundle');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\CalendarBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\payum-bundle/Resources/translations\\PayumBundle.en.yml'), 'en', 'PayumBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\payum-bundle/Resources/translations\\PayumBundle.hr.yml'), 'hr', 'PayumBundle');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('paths' => array((dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\core\\Payum\\Core/Resources/views') => 'PayumCore', (dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Symfony/Resources/views') => 'PayumSymfonyBridge'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\core\\Payum\\Core/Resources/views'), 'PayumCore');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Symfony/Resources/views'), 'PayumSymfonyBridge');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\SiteBundle/Resources/views'), 'CountrynsideSite');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\UserBundle/Resources/views'), 'CountrynsideUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\CalendarBundle/Resources/views'), 'CountrynsideCalendar');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Countrynside\\PaymentBundle/Resources/views'), 'CountrynsidePayment');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\jms\\payment-core-bundle\\JMS\\Payment\\CoreBundle/Resources/views'), 'JMSPaymentCore');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/information_evennement$'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/abonnement$'), array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CountrynsidePaymentBundle' => 'Countrynside\\PaymentBundle\\CountrynsidePaymentBundle',
            ...
            'twig.options' => array(
                'paths' => array(
                    'C:\\wamp\\www\\Symfony\\vendor\\payum\\core\\Payum\\Core/Resources/views' => 'PayumCore',
                    'C:\\wamp\\www\\Symfony\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Symfony/Resources/views' => 'PayumSymfonyBridge',
                ),
                'debug' => true,
            ...
            'payum.listener.reply_to_http_response.class' => 'Payum\\Bundle\\PayumBundle\\EventListener\\ReplyToHttpResponseListener',
            'payum.action.execute_same_request_with_model_details.class' => 'Payum\\Core\\Action\\ExecuteSameRequestWithModelDetailsAction',
            'payum.action.get_http_request.class' => 'Payum\\Core\\Bridge\\Symfony\\Action\\GetHttpRequestAction',
            'payum.action.obtain_credit_card.class' => 'Payum\\Core\\Bridge\\Symfony\\Action\\ObtainCreditCardAction',
            'payum.action.render_template.class' => 'Payum\\Core\\Bridge\\Twig\\Action\\RenderTemplateAction',
            'payum.action.capture_order.class' => 'Payum\\Core\\Action\\CaptureOrderAction',
            'payum.security.http_request_verifier.class' => 'Payum\\Core\\Bridge\\Symfony\\Security\\HttpRequestVerifier',
            'payum.security.token_factory.class' => 'Payum\\Core\\Bridge\\Symfony\\Security\\TokenFactory',
            ...
            'payum.paypal.express_checkout_nvp.action.api.create_billing_agreement.class' => 'Payum\\Paypal\\ExpressCheckout\\Nvp\\Action\\Api\\CreateBillingAgreementAction',
            'payum.paypal.express_checkout_nvp.action.api.do_reference_transaction.class' => 'Payum\\Paypal\\ExpressCheckout\\Nvp\\Action\\Api\\DoReferenceTransactionAction',
            ...
            'payum.paypal.express_checkout_nvp.action.fill_order_details.class' => 'Payum\\Paypal\\ExpressCheckout\\Nvp\\Action\\FillOrderDetailsAction',
            'payum.context.mypayment.payment.class' => 'Payum\\Core\\Payment',
            ...
            'payment.encryption_service.secret' => 'asecret',
